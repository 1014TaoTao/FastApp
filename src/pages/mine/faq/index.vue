        ...
        <view class="support-card theme-card">
          ...
          <view class="card-body">
            <text class="card-desc theme-text-secondary"
              >专业的技术团队为您提供7×24小时服务支持</text
            >
            <view class="support-grid">
              <view
                class="support-item theme-card"
                @tap="handleContact('email')"
              >
              ...
              >
                ...
                <view class="support-info">
                  ...
                  <text class="support-value theme-text-secondary"
                    >400-123-4567</text
                  >
                </view>
              </view>
              ...
              <view class="faq-list">
                ...
                >
                  ...
                  <view v-if="currentFaq === index" class="faq-answer">
                    <text class="answer-text theme-text-secondary">{{
                      item.answer
                    }}</text>
                  </view>
                </view>
              ...
              <view class="feature-list">
                ...
                >
                  ...
                  <view class="feature-content">
                    <text class="feature-name theme-text-primary">{{
                      feature.name
                    }}</text>
                    <text class="feature-desc theme-text-secondary">{{
                      feature.desc
                    }}</text>
                  </view>
                </view>
              ...
              <view class="guide-section">
                <view class="guide-header flex-center">
                  <wd-icon
                    ...
                    :color="themeVars.colorTheme"
                  />
                  <text class="guide-title theme-text-primary ml-md"
                    >快速开始</text
                  >
                </view>
                <view class="guide-steps">
                  ...
                  >
                    <view class="step-indicator">
                      <view class="step-number flex-center">{{
                        index + 1
                      }}</view>
                      <view
                    ...
                    <view class="step-content">
                      <text class="step-title theme-text-primary">{{
                        step.title
                      }}</text>
                      <text
                        v-if="step.desc"
                        class="step-desc theme-text-secondary"
                      >
                        {{ step.desc }}
                      </text>
                    </view>
